Add-Type -AssemblyName PresentationFramework # To enable the use of WPF Forms
...
$xamlFile = "C:\Users\jkagiwada\Documents\Playground\GetFixedDisk\GetFixedDisk\MainWindow.xaml"
